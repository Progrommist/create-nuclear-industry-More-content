...
public class Config {
    ...
    static {
        ...
        AUTO_DISCOVER_TICKS = BUILDER
                ...
                .defineInRange("auto_discover_ticks", 100, -1, Integer.MAX_VALUE);
        ...
        MELTDOWN_CHECK_TICKS = BUILDER
                ...
                .defineInRange("meltdown_check_ticks", 100, -1, Integer.MAX_VALUE);
        ...
        HEAT_SYNC_TICKS = BUILDER
                ...
                .defineInRange("heat_sync_ticks", 10, -1, Integer.MAX_VALUE);
        ...
        ADVANCEMENT_TRIGGER_TICKS = BUILDER
                ...
                .defineInRange("advancements_trigger_ticks", 200, -1, Integer.MAX_VALUE);

...
public class SteamTurbineOutputSteamDisplaySource extends SingleLineDisplaySource {
    @Override
    protected MutableComponent provideLine(DisplayLinkContext context, DisplayTargetStats stats) {
        BlockEntity be = context.getSourceBlockEntity();
        if (!(be instanceof SteamTurbineBlockEntity stbe))
            return Component.literal("---");
        return Component.literal(String.format("%d/%d", stbe.steamOutputAmount(), stbe.steamOutputCapacity()));
    }
